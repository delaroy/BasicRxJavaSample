...
import com.delaroystudios.roomrxjava.Injection;
...
public class UserActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAgeInput = (EditText) findViewById(R.id.user_age_input);
        mSexInput = (EditText) findViewById(R.id.user_sex_input);
    ...
    protected void onStart() {
        ...
        mDisposable.add(mViewModel.getUserAge()
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
                .subscribe(userAge -> mAge.setText(userAge),
                        throwable -> Log.e(TAG, "Unable to update username", throwable)));

        mDisposable.add(mViewModel.getUserSex()
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
                .subscribe(userSex -> mSex.setText(userSex),
                        throwable -> Log.e(TAG, "Unable to update username", throwable)));
